...
export const events = mysqlTable('events', {
  ...
  skpText: varchar('skp_text', { length: 50 }),
  skpSubtitle: varchar('skp_subtitle', { length: 100 }),
  hasCertificate: boolean('has_certificate').default(true).notNull(),
  priceText: varchar('price_text', { length: 100 }).default('Gratis'),
  speakersText: varchar('speakers_text', { length: 255 }),
  categoryBadge: varchar('category_badge', { length: 50 }).default('WEBINAR'),
