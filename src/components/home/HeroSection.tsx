...
import { Award, GraduationCap, ChevronRight, TrendingUp, Users, Handshake, Lightbulb } from 'lucide-react';
...
/**
 * Client Component: Hero section dengan animasi teks dan Link navigasi.
 * Tetap client component karena menggunakan animasi motion dan state.
 */
export default function HeroSection({ memberCount, activeGenYears }: HeroSectionProps) {
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
          ...
          <div className="mt-16 lg:mt-0 lg:col-span-5 relative flex justify-center items-center" id="hero-visual-card">
            ...
            <div className="relative w-full max-w-md lg:max-w-none h-[420px] rounded-3xl border border-white/40 bg-white/20 backdrop-blur-xl shadow-2xl shadow-indigo-100/30 overflow-hidden flex items-center justify-center">
              ...
              {/* CENTER NODE */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 rounded-full bg-gradient-to-br from-blue-600 to-indigo-600 border-4 border-white flex flex-col items-center justify-center shadow-xl shadow-blue-600/30 text-white z-20 hover:scale-105 transition-transform duration-300">
              ...
              <motion.div
                ...
                animate="animate"
                className="absolute top-[8%] left-1/2 -translate-x-1/2 flex flex-col items-center justify-center p-3 rounded-2xl bg-white/60 backdrop-blur-md border border-white/40 shadow-sm hover:shadow-blue-500/15 hover:border-blue-400/40 hover:bg-white/80 transition-all duration-300 group w-28 text-center z-10"
              >
              ...
              <motion.div
                ...
                animate="animate"
                className="absolute top-[26%] right-[6%] flex flex-col items-center justify-center p-3 rounded-2xl bg-white/60 backdrop-blur-md border border-white/40 shadow-sm hover:shadow-blue-500/15 hover:border-blue-400/40 hover:bg-white/80 transition-all duration-300 group w-28 text-center z-10"
              >
              ...
              <motion.div
                ...
                animate="animate"
                className="absolute bottom-[26%] right-[6%] flex flex-col items-center justify-center p-3 rounded-2xl bg-white/60 backdrop-blur-md border border-white/40 shadow-sm hover:shadow-blue-500/15 hover:border-blue-400/40 hover:bg-white/80 transition-all duration-300 group w-28 text-center z-10"
              >
              ...
              <motion.div
                ...
                animate="animate"
                className="absolute bottom-[8%] left-1/2 -translate-x-1/2 flex flex-col items-center justify-center p-3 rounded-2xl bg-white/60 backdrop-blur-md border border-white/40 shadow-sm hover:shadow-blue-500/15 hover:border-blue-400/40 hover:bg-white/80 transition-all duration-300 group w-36 text-center z-10"
              >
              ...
              <motion.div
                ...
                animate="animate"
                className="absolute bottom-[26%] left-[6%] flex flex-col items-center justify-center p-3 rounded-2xl bg-white/60 backdrop-blur-md border border-white/40 shadow-sm hover:shadow-blue-500/15 hover:border-blue-400/40 hover:bg-white/80 transition-all duration-300 group w-30 text-center z-10"
              >
              ...
              <motion.div
                ...
                animate="animate"
                className="absolute top-[26%] left-[6%] flex flex-col items-center justify-center p-3 rounded-2xl bg-white/60 backdrop-blur-md border border-white/40 shadow-sm hover:shadow-blue-500/15 hover:border-blue-400/40 hover:bg-white/80 transition-all duration-300 group w-28 text-center z-10"
              >
