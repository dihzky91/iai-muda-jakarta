...
/**
 * Server Component: Featured event spotlight dengan navigasi Link.
          ...
          <div className="md:col-span-5 flex justify-start md:justify-end">
            {event.registrationUrl ? (
              <a
                ...
                className="inline-flex items-center gap-2 rounded-2xl bg-white px-6 py-4 text-sm font-bold text-blue-700 shadow-md hover:bg-slate-50 transition-all"
              >
