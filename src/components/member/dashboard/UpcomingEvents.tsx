...
export default function UpcomingEvents({ events }: UpcomingEventsProps) {
  return (
    <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm h-full flex flex-col justify-between">
      <div>
      ...
      <div className="px-6 py-3 border-t border-slate-100 mt-auto">
        <Link
          href="/portal/events"
